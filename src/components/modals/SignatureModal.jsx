      ...
      <div className="bg-dark-surface border border-dark-border rounded-2xl max-w-lg w-full p-6 shadow-2xl">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center space-x-2">
            ...
            <div>
              <h3 className="text-base font-semibold text-white">Create E-Signature</h3>
              <p className="text-xs text-slate-400">Draw your signature with your mouse or stylus</p>
            </div>
          </div>
        ...
        <div className="border border-slate-700 rounded-xl bg-white overflow-hidden relative mb-4">
          ...
          />
          <div className="absolute bottom-2 left-4 text-[10px] text-slate-400 select-none">
        ...
        <div className="flex items-center justify-between">
          <button
            onClick={handleClear}
            className="flex items-center space-x-1.5 px-3 py-2 rounded-lg bg-dark-card hover:bg-dark-hover border border-dark-border text-xs text-slate-300 transition"
          >
