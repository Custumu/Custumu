...
- **Multi-Document Comparison:**
  ...
  - Automated visual & semantic diff showing added, removed, and modified clauses (e.g., *"Payment grace period reduced from 30 to 14 days"*).

### 2.3 Layer 3: AI-Driven Document Action Engine
Users can trigger document modifications via natural language commands:
- *"Delete page 2 and 4, add a cover page, and place our logo in the top right."*
- *"Redact all Social Security Numbers and email addresses across all 50 pages."*
- *"Resize margins and compress to under 2MB for email attachment."*
