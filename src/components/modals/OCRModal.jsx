...
Data Retention: In Private Mode, zero document data leaves client device memory.`;
  ...
  return (
    <div className="fixed inset-0 bg-black/75 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-fade-in">
      <div className="bg-dark-surface border border-dark-border rounded-2xl max-w-xl w-full p-6 shadow-2xl">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center space-x-2">
            ...
            <div>
              <h3 className="text-base font-semibold text-white">OCR & Text Recognition</h3>
              <p className="text-xs text-slate-400">Extract selectable, searchable text from document scans</p>
            </div>
          </div>
        ...
        {/* OCR Result Box */}
        <div className="border border-dark-border rounded-xl bg-dark-card p-3 mb-4 max-h-72 overflow-y-auto font-mono text-[11px] text-slate-300 whitespace-pre-wrap leading-relaxed">
          {sampleOcrText}
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            <button
              onClick={handleCopy}
              className="flex items-center space-x-1.5 px-3 py-2 rounded-lg bg-dark-card hover:bg-dark-hover border border-dark-border text-xs text-slate-200 transition"
            >
