      ...
      <div className="px-3 py-2 border-b border-dark-border/60 bg-dark-card/40 flex items-center gap-1.5 overflow-x-auto text-[11px] no-scrollbar">
        {quickPrompts.map((qp, i) => (
          <button
            ...
            className="whitespace-nowrap px-2.5 py-1 rounded-full bg-dark-surface border border-dark-border hover:border-brand-500/50 hover:text-brand-300 text-slate-300 transition text-[11px] disabled:opacity-40"
          >
            {qp.label}
          </button>
        ))}
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4 text-xs">
        {messages.map((m) => (
          ...
          >
            ...
            >
              ...
              {/* Action Button Card */}
              {m.action && (
                <div className="mt-3 pt-2.5 border-t border-dark-border/80">
        ...
        {isStreaming && (
          <div className="flex flex-col items-start animate-fade-in">
            ...
            <div className="p-3 rounded-2xl max-w-[92%] leading-relaxed bg-dark-card border border-brand-500/40 text-slate-200 rounded-tl-sm shadow-md shadow-brand-500/5">
              <div className="whitespace-pre-wrap">
      ...
      <div className="p-3 border-t border-dark-border bg-dark-surface">
        ...
        >
          <input
            ...
            className="w-full pl-3 pr-10 py-2.5 rounded-xl bg-dark-card border border-dark-border focus:border-brand-500 text-xs text-white placeholder-slate-500 outline-none transition disabled:opacity-50"
          />
          <button
            type="submit"
