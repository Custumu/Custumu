    ...
    <div className="max-w-4xl mx-auto px-4 py-12 sm:py-16 text-center animate-fade-in">
      ...
      <div
        ...
        className={`glass-panel rounded-2xl p-8 sm:p-12 transition-all duration-200 relative group cursor-pointer border-2 ${
          isDragging
            ...
            : 'border-dashed border-dark-border hover:border-brand-500/50 hover:bg-dark-card/50'
        }`}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-12 text-left">
        <div className="glass-card p-4 rounded-xl border border-dark-border">
          ...
          <h4 className="text-sm font-semibold text-white mb-1">100% Private Mode</h4>
        ...
        <div className="glass-card p-4 rounded-xl border border-dark-border">
          ...
          <h4 className="text-sm font-semibold text-white mb-1">Conversational Editing</h4>
          <p className="text-xs text-slate-400 leading-relaxed">
        ...
        <div className="glass-card p-4 rounded-xl border border-dark-border">
          ...
          <h4 className="text-sm font-semibold text-white mb-1">Unified 3-Panel Studio</h4>
          <p className="text-xs text-slate-400 leading-relaxed">
